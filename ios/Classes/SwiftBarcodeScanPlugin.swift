...
public class SwiftCodebarScanPlugin: NSObject, FlutterPlugin, CodebarScannerViewControllerDelegate {
    
    private var result: FlutterResult?
    private var hostViewController: UIViewController?
    
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "br.com.scrumlab.codebarscan", binaryMessenger: registrar.messenger())
        let instance = SwiftCodebarScanPlugin()
    ...
    private func showBarcodeView(config: Configuration? = nil) {
        let scannerViewController = CodebarScannerViewController()
    ...
    func didScanBarcodeWithResult(_ controller: CodebarScannerViewController?, scanResult: ScanResult) {
      do {
    ...
    func didFailWithErrorCode(_ controller: CodebarScannerViewController?, errorCode: String) {
