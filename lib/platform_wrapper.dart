...
/// Simply call `var barcode = await CodebarScanner.scan()` to scan a barcode
class CodebarScanner {
  ...
  static const MethodChannel _channel =
      MethodChannel('br.com.scrumlab.codebarscan');

  /// The event channel
  static const EventChannel _eventChannel =
      EventChannel('br.com.scrumlab.codebarscan/events');
