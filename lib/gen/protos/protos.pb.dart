...
class Configuration extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Configuration', createEmptyInstance: create)
    ...
    ..pc<CodebarFormat>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'restrictFormat', $pb.PbFieldType.PE, protoName: 'restrictFormat', valueOf: CodebarFormat.valueOf, enumValues: CodebarFormat.values)
  ...
  factory Configuration({
    ...
    $core.Iterable<CodebarFormat> restrictFormat,
    $core.int useCamera,
  ...
  @$pb.TagNumber(2)
  $core.List<CodebarFormat> get restrictFormat => $_getList(1);
...
class ScanResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ScanResult', createEmptyInstance: create)
    ..e<ResultsType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: ResultsType.Barcode, valueOf: ResultsType.valueOf, enumValues: ResultsType.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rawContent', protoName: 'rawContent')
    ..e<CodebarFormat>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'format', $pb.PbFieldType.OE, defaultOrMaker: CodebarFormat.unknown, valueOf: CodebarFormat.valueOf, enumValues: CodebarFormat.values)
  ...
  @$pb.TagNumber(1)
  ResultsType get type => $_getN(0);
  @$pb.TagNumber(1)
  set type(ResultsType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  CodebarFormat get format => $_getN(2);
  @$pb.TagNumber(3)
  set format(CodebarFormat v) { setField(3, v); }
  @$pb.TagNumber(3)
