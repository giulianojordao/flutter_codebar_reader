...
import 'package:codebarscan/codebarscan.dart';
...
class _MyAppState extends State<_MyApp> {
  ...
  static final _possibleFormats = CodebarFormat.values.toList()
    ..removeWhere((e) => e == CodebarFormat.unknown);

  List<CodebarFormat> selectedFormats = [..._possibleFormats];
  ...
  initState() {
    ...
    Future.delayed(Duration.zero, () async {
      _numberOfCameras = await CodebarScanner.numberOfCameras;
      setState(() {});
    });
  }
  ...
  Future scan() async {
    try {
      ...
      var result = ScanResult(
        type: ResultsType.Error,
        format: CodebarFormat.unknown,
      );

      if (e.code == CodebarScanner.cameraAccessDenied) {
        setState(() {
